...
unlink "bin_3.ctl";
CPU::Z80::Disassembler->create_control_file("bin_3.ctl", "bin_3.bin", 0xD000);

$dis->load_control_file("bin_3.ctl");
$dis->memory->load_file( "bin_3.bin", 0xD000);
